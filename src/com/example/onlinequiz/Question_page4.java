...
public class Question_page4 extends Activity {
	TextView e1;
	Button b1,b2;
	//String count;
	Bundle bd;
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    b1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(ans.equalsIgnoreCase("c. onCreate()"))
					{
	...
	b2.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					//startActivity(i1);
					Intent i1=new Intent(Question_page4.this,Question_page5.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.question_page4, menu);
		return true;
	}

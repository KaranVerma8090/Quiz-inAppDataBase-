...
public class Question_page5 extends Activity {
	TextView e1;
	Button b1,b2;
	//String count;
	Bundle bd;
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    b1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(ans.equalsIgnoreCase("c. View"))
					{
	...
	b2.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					//startActivity(i1);
					Intent i1=new Intent(Question_page5.this,Final_page.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.question_page5, menu);
		return true;
	}

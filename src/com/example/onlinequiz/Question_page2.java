...
public class Question_page2 extends Activity {
	TextView e1;
	Button b1,b2;
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    b1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(ans.equalsIgnoreCase("c. retrieveResourseById(int id)"))
					{
	...
	b2.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					//startActivity(i1);
					Intent i1=new Intent(Question_page2.this,Question_page3.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.question_page2, menu);
		return true;
	}

...
public class Question_page1 extends Activity {
TextView e1;
Button b1,b2;
...
@Override
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    b1.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(ans.equalsIgnoreCase("a. onCreateOptionsMenu()"))
					{
						...
						Toast.makeText(getBaseContext(),"",2000).show();
					}
					else
					{
					Toast.makeText(getBaseContext(),"data are saved successfully",2000).show();
					//Toast.makeText(getBaseContext(),y,2000).show();
				}
					//Toast.makeText(getBaseContext(),y,2000).show();
					}
			});
	...
	b2.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					//startActivity(i1);
					Intent i1=new Intent(Question_page1.this,Question_page2.class);
					i1.putExtra("next",String.valueOf(count));
					startActivity(i1);
				}
			});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.question_page1, menu);
		return true;
	}
